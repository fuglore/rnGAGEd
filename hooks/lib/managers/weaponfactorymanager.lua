function WeaponFactoryManager:get_part_desc_by_part_id_from_weapon(part_id, factory_id, blueprint)
	...
	local desc_id = part.desc_id or tweak_data.blackmarket.weapon_mods[part_id].desc_id or tweak_data.weapon.factory[factory_id].override and tweak_data.weapon.factory[factory_id].override[part_id] and tweak_data.weapon.factory[factory_id].override[part_id].desc_id
